...
import { View, Text, Pressable, StyleSheet, KeyboardAvoidingView, Platform, Image, ScrollView } from 'react-native';
...
export default function LoginScreen({ onLogin, isAddMode, onCancel }: LoginScreenProps) {
  ...
  const advancedDisabled = isLoading || (authMode === 'basic' ? !canBasicLogin : !canOauthLogin);
            ...
            {advancedOpen ? (
              <View style={styles.advanced}>
                ...
                <Button
                  ...
                  style={styles.loginButton}
                >
                  {authMode === 'basic' ? 'Sign in with password' : 'Sign in with OAuth'}
                </Button>
              </View>
            ) : null}
          </View>
